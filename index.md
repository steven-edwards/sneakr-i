...
- type: intro
  template: intro
  content: "**Seen it? Send it!**  \nEasily send that article you're reading to someone
    straight away via your local postal service! "
  actions:
  - label: Get Started
    url: "/generic"
    is_scrolly: false
    is_primary: false
  title: Sneakr.it
  img_path: "/images/newspaper-article.jpg"
